%% Figure 3B: Sex differences and cardiac disease influence cardiac effects
%% of COVID-19 drugs. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Test_Concentration = [7559.6; 1025.3];% concentration of CQ and AZ (from PK results Fig 2)
