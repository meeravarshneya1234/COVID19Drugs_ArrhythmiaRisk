...
function [p,c] = define_parameters(celltype,phys_state,gender)
...
%     if  strcmp(celltype,'epi')==1 % these don't seem correct 
%         c.GNaL=c.G.GNaL*0.6;
%         c.Gto=c.G.Gto*4.0;
%         c.GKr_=c.G.GKr_*1.3;
%         c.GKs_=c.G.GKs_*1.4;
...
%         c.PCa_=c.G.PCa_*1.2;
%         c.Pnak=c.G.Pnak*0.9;
%         p.cmdnmax=0.05; % need to check value for this 
